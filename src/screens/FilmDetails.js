      ...
      <ScrollView style={styles.bodyContainer}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.tagsInRow}>
            <Tag title="Year" content={film.Year} />
            <Tag title="Rated" content={film.Rated} />
          </View>
          <Tag title="Runtime" content={film.Runtime} />
          <Tag title="Genre" content={film.Genre} />
          ...
          <Tag title="Actors" content={film.Actors} />
          <Tag title="Production" content={film.Production} />
        </View>
      </ScrollView>
      <LinearGradient
